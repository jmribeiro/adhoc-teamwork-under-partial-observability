...
from backend.environments.overcooked_ai_py.utils import load_from_json
...
class MultiFramePygameImage:
    ''' use to read frames of images from backend.environments.overcooked-demo repo easly
    '''
