import unittest
from backend.environments.overcooked_ai_py.planning.planners import MediumLevelActionManager
from backend.environments.overcooked_ai_py.mdp.actions import Direction, Action
from backend.environments.overcooked_ai_py.mdp.overcooked_mdp import OvercookedGridworld, PlayerState, ObjectState, SoupState, OvercookedState
from backend.environments.overcooked_ai_py.mdp.overcooked_env import OvercookedEnv
from backend.environments.overcooked_ai_py.agents.benchmarking import AgentEvaluator
from backend.environments.overcooked_ai_py.agents.agent import AgentPair, GreedyHumanModel
...
class TestScenarios(unittest.TestCase):
    def repetative_runs(self, evaluator, num_games=10):
        ...
        h0 = GreedyHumanModel(evaluator.env.action_manager)
        h1 = GreedyHumanModel(evaluator.env.action_manager)
        ...
        h3 = GreedyHumanModel(evaluator.env.action_manager)
        h4 = GreedyHumanModel(evaluator.env.action_manager)
