...
from backend.environments.overcooked_ai_py.agents.agent import RandomAgent
from backend.environments.overcooked_ai_py.mdp.overcooked_mdp import OvercookedGridworld, OvercookedState
from backend.environments.overcooked_ai_py.visualization.state_visualizer import StateVisualizer
from backend.environments.overcooked_ai_py.utils import load_from_json, generate_temporary_file_path
from backend.environments.overcooked_ai_py.mdp.overcooked_mdp import Recipe
...
class TestStateVisualizer(unittest.TestCase):
    ...
    def test_trajectory_visualization(self):
        ...
        tag = "test_state_visualizer"
        file = "test_trajectory.json"
        traj_path = f'../data/testing/{tag}/{file}'
        test_trajectory = AgentEvaluator.load_traj_from_json(traj_path)
        ...
        result_img_directory_path = StateVisualizer().display_rendered_trajectory(test_trajectory, action_probs=action_probs, ipython_display=True)
