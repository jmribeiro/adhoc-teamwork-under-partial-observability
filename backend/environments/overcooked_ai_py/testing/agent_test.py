...
from backend.environments.overcooked_ai_py.agents.agent import AgentPair, FixedPlanAgent, GreedyHumanModel, RandomAgent, SampleAgent
from backend.environments.overcooked_ai_py.mdp.actions import Direction, Action
from backend.environments.overcooked_ai_py.mdp.overcooked_mdp import OvercookedGridworld, OvercookedState, PlayerState, ObjectState
from backend.environments.overcooked_ai_py.mdp.overcooked_env import OvercookedEnv
from backend.environments.overcooked_ai_py.planning.planners import MediumLevelActionManager, NO_COUNTERS_PARAMS
...
class TestAgentEvaluator(unittest.TestCase):
    ...
    def test_mlam_computation(self):
        try:
            self.agent_eval.env.action_manager
